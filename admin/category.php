...
if(strlen($_SESSION['alogin'])==0)
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        if(in_array($ext, $supported_image)){
            ...
            if(move_uploaded_file($_FILES["img"]["tmp_name"],"../catimage/".$filename)){


//$sql=mysqli_query($con,"update category set categoryName='$category',categoryDescription='$description',updationDate='$currentTime',img='$filename' where id='$id'");


                $sql=mysqli_query($con,"insert into category(categoryName,categoryDescription,img,position) values('$category','$description','$filename','$position')");
                    ...
                    <div class="module">
                        ...
                        <div class="module-body">
                            ...
                            <form class="form-horizontal row-fluid" name="Category" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="basicinput">Position No.</label>
                                    <div class="controls">
                                        <input type="text" placeholder="Enter Position eg 1"  name="position" class="span8 tip" required>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" name="img" id="img" value="" class="span8 tip" required>
                                    </div>
                                </div>
