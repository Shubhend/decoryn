        ...
        <ul class="widget widget-menu unstyled">
            <li>
                ...
                <ul class="widget widget-menu unstyled">
                    ...
                    <li><a href="other.php"><i class="menu-icon icon-table"></i>Other settings </a></li>
                    <!--   <li><a href="subcategory.php"><i class="menu-icon icon-tasks"></i>Sub Category </a></li>
                     <li><a href="carrier.php"><i class="menu-icon icon-paste"></i>Carrer Request </a></li>
                    <li><a href="manage-users.php"><i class="menu-icon icon-table"></i>User Record </a></li>-->
